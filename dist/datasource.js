      ...
      _export('PiWebApiDatasource', PiWebApiDatasource = function () {
        ...
        _createClass(PiWebApiDatasource, [{
          ...
          value: function annotationQuery(options) {
            ...
            var url = this.url + '/assetdatabases/' + this.afdatabase.webid + '/eventframes?' + 'startTime=' + options.range.from.toJSON() + '&endTime=' + options.range.to.toJSON();
            ...
            return this.backendSrv.datasourceRequest({
              ...
              var annotations = _.map(items, _.curry(_this3.eventFrameToAnnotation)(annotationOptions, false));
              if (options.annotation.showEndTime) {
                var ends = _.map(items, _.curry(_this3.eventFrameToAnnotation)(annotationOptions, true));
